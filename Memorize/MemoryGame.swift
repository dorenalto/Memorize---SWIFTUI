...
struct MemoryGame<CardContent> where CardContent: Equatable {
    ...
    struct Card: Identifiable {
        ...
        // can be zero which means "no bonus point" for this car
        ...
        // the accumulated time this card has been face up in the pass
        ...
        // whether we are currently face up, unmatched and have not yed used up the bonus window
